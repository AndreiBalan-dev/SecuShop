  ...
  return (
    <>
      ...
      <section className="bg-red-600 text-white py-8">
        <div className="max-w-7xl mx-auto px-6 text-center space-y-2">
          <h2 className="text-3xl sm:text-4xl font-bold">
            Mouse Gamer RGB – Comentarii Vulnerabile XSS
          </h2>
          <p className="text-red-100 text-sm">
            Acest modul de recenzii permite executarea de cod JavaScript.
          </p>
        </div>
      </section>
          ...
          <div className="lg:col-span-3 space-y-10">
            ...
            <section className="bg-red-50 border border-red-300 text-red-800 p-4 rounded flex items-center gap-3">
              <span className="font-bold text-lg">
                ⚠️ Avertisment XSS activ!
              </span>
              <p className="text-sm">
                Comentariile sunt afișate fără filtrare. Inserarea de cod
                JavaScript este posibilă.
              </p>
            </section>
            ...
            <section className="bg-white border border-neutral-200 rounded shadow p-6 space-y-4">
              <h3 className="text-xl font-semibold text-red-600 flex items-center gap-2">
                ...
                Scrie o recenzie (XSS Vulnerabil)
              </h3>
              <label className="block">
                ...
                <input
                  type="text"
                  placeholder="Ex: Ana"
                  className="mt-1 w-full px-4 py-2 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-500"
                  value={author}
              ...
              <label className="block">
                ...
                <textarea
                  ...
                  className="mt-1 w-full px-4 py-2 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-500 h-24 resize-none"
                  value={content}
      ...
      <footer className="bg-white border-t border-neutral-200 text-neutral-500 text-xs text-center py-6">
        © 2025 SecuShop™ · Pagina demonstrativă XSS Vulnerabil
      </footer>
    </>
  );
}
